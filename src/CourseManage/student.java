...
public class student {
      public void insertUpdateDeleteStudent(char operation, Integer id, String fname, 
            String lname, String sex, String phone, String address, String username, String pass2){
        ...
        { 
            try 
               {
                   ps = con.prepareStatement("INSERT INTO student(first_name,last_name,sex,phone,address,username,password) VALUES (?,?,?,?,?,?,?)");
      ...
      public static String getMD5Hash1(String s) throws NoSuchAlgorithmException {
