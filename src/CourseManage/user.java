...
public class user {
    ...
    try {
     ...
     public void insertUser(String username,String password,String course,String fname ){
         ...
         Connection con = MyConnection.getConnection();
            ...
            try 
               {
                   ps = con.prepareStatement("INSERT INTO user(username,password,course,fname) VALUES (?,?,?,?)");
